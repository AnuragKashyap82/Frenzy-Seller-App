...
import kashyap.anurag.frenzyseller.databinding.ActivityActiveProductsBinding;
...
public class ActiveProductsActivity extends AppCompatActivity {
    private ActivityActiveProductsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityActiveProductsBinding.inflate(getLayoutInflater());
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ActiveProductsActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void loadMyShopProductOnly(ModelInCompleteDetails modelInCompleteDetails) {
        ...
        if (shopId.equals(firebaseAuth.getUid())){
            ...
            adapterInProgressQC = new AdapterInProgressQC(ActiveProductsActivity.this, inCompleteDetailsArrayList);
            binding.activeProductsRv.setAdapter(adapterInProgressQC);
            ...
            binding.progressBar.setVisibility(View.GONE);
            Toast.makeText(ActiveProductsActivity.this, "Uid Not Matches!!!", Toast.LENGTH_SHORT).show();
        }
    }
}