...
import kashyap.anurag.frenzyseller.Adapter.AdapterReturnedOrder;
import kashyap.anurag.frenzyseller.Models.ModelAllOrders;
import kashyap.anurag.frenzyseller.databinding.ActivityReturnedOrderBinding;

public class ReturnedOrderActivity extends AppCompatActivity {
    private ActivityReturnedOrderBinding binding;
    private AdapterReturnedOrder adapterReturnedOrder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityReturnedOrderBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        firebaseAuth = FirebaseAuth.getInstance();

        loadAllReturnedOrder();
    ...
    private void loadAllReturnedOrder() {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ReturnedOrderActivity.this, "Not Found!!!!", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                ...
                .addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException error) {
                        ...
                        if (orderStatus.equals("returned")){
                            ...
                            adapterReturnedOrder = new AdapterReturnedOrder(ReturnedOrderActivity.this, allOrdersArrayList);
                            binding.returnedOrdersRv.setAdapter(adapterReturnedOrder);
                            adapterReturnedOrder.notifyDataSetChanged();
                            binding.progressBar.setVisibility(View.GONE);

                        }else {
                            Toast.makeText(ReturnedOrderActivity.this, "No Returned Orders!!!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
