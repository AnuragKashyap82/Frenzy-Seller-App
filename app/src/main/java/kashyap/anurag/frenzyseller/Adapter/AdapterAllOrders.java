...
public class AdapterAllOrders extends RecyclerView.Adapter<AdapterAllOrders.HolderAllOrders> {

    private Context context;
    private ArrayList<ModelAllOrders> allOrdersArrayList;

    public AdapterAllOrders(Context context, ArrayList<ModelAllOrders> allOrdersArrayList) {
    ...
    @NonNull
    @Override
    public HolderAllOrders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.order_item_layout, parent, false);
        return new HolderAllOrders(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HolderAllOrders holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("BUTTON_CODE", "ALL_ORDER");
                context.startActivity(intent);
            }
        });
    }

    private void loadOrderDetails(String orderBy, String orderId, HolderAllOrders holder) {
    ...
    private void loadProductDetails(String productId, HolderAllOrders holder) {
    ...
    public class HolderAllOrders extends RecyclerView.ViewHolder {

        private ImageView productImage;
        private TextView productTitle, deliveryWithinTv, orderDate;

        public HolderAllOrders(@NonNull View itemView) {
            super(itemView);
